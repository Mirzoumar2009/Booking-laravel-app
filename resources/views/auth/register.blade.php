...
<div class="register-box">
    <div class="register-logo"> <a href="../../../dist/css/adminlte.css"><b>Admin</b>LTE</a> </div> <!-- /.register-logo -->
    <div class="card">
        <div class="card-body register-card-body">
            ...
            <form action="{{route('register')}}" method="post">
                ...
                <div class="input-group mb-3"> <input type="password" name="password_confirmation" required autocomplete="new-password"  class="form-control" placeholder="Confirm Password">
                    <div class="input-group-text"> <span class="bi bi-lock-fill"></span> </div>
                </div>
                <!--begin::Row-->
                <!-- Confirm Password -->
                <div class="mt-4">
                    <!-- Здесь будет отображение ошибок для password_confirmation -->
